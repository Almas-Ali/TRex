...
@push('privacy-policy-active')active @endpush
@push('scripts')
<meta name="description" content="Privacy Policy of {{ website()->site_name }}">
<link rel="canonical" href="{{ route('privacy_policy') }}">
<meta property="og:locale" content="en_US">
<meta property="og:type" content="Privacy Policy">
<meta property="og:title" content="Privacy Policy - {{ website()->site_name }}">
<meta property="og:description" content="Privacy Policy of {{ website()->site_name }}">
...
<meta name="twitter:title" content="Privacy Policy - {{ website()->site_name }}">
<meta name="twitter:description" content="Privacy Policy of {{ website()->site_name }}">
...
<div class="container">
  <div class="card my-3 p-2">
    ...
    <div class="page">
      <div class="h1">
        <div class="container">
          <p class="title">Privacy Policy of {{ website()->site_name }}</p>
        </div>
      </div>
      <div class="translations-content-container">
        <div class="container">
          <div class="tab-content translations-content-item en visible" id="en">
            ...
            <ul>
              ...
              <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;,
                  &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {{ website()->site_name }}.
                </p>
              </li>
              <li>
              ...
              <li>
                <p><strong>Website</strong> refers to {{ website()->site_name }}, accessible from <a href="{{ route('home') }}"
                    rel="external nofollow noopener" target="_blank">{{ route('home') }}</a></p>
              </li>
              <li>
            ...
            <ul>
              <li>
                <p>By email: <a href="mailto:{{ website()->site_author_email }}">{{ website()->site_author_email }}</a>
                </p>
              </li>
              <li>
                <p>By visiting this page on our website: <a href="{{ route('home') }}" rel="external nofollow noopener"
                    target="_blank">{{ route('home') }}</a></p>
              </li>
            </ul>
          </div>
        </div>
