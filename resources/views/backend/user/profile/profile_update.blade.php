...
<div class="container-fluid">
    ...
    <form action="{{ route('profile_update_save') }}" method="POST" class="p-2" enctype="multipart/form-data">
        @csrf
        <div class="form-control">
            ...
            <div>
                ...
                <input type="text" id="username" name="username" class="form-control my-2 disabled"
